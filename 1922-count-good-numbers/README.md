...
<p>Given an integer <code>n</code>, return <em>the <strong>total</strong> number of good digit strings of length </em><code>n</code>. Since the answer may be large, <strong>return it modulo </strong><code>10<sup style="">9</sup> + 7</code>.</p>
...
<ul>
	<li><code>1 &lt;= n &lt;= 10<sup style="">15</sup></code></li>
</ul>
</div>