...
<p>Return <em>the number of binary trees we can make</em>. The answer may be too large so return the answer <strong>modulo</strong> <code>10<sup style="">9</sup> + 7</code>.</p>
...
<ul>
	...
	<li><code>2 &lt;= arr[i] &lt;= 10<sup style="">9</sup></code></li>
